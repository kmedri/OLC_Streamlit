...
st.write('Omdena Liverpool chapter was made up of a team from over 10 different timezones. Despite the distances and time separations we manged to get together and successfully collaborate and produce some ecxcellent work.')
